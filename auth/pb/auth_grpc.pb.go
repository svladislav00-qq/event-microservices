...
const (
	...
	AuthService_PromoteToModerator_FullMethodName = "/pb.AuthService/PromoteToModerator"
	AuthService_GetMe_FullMethodName              = "/pb.AuthService/GetMe"
	AuthService_GetUsersByIDs_FullMethodName      = "/pb.AuthService/GetUsersByIDs"
)
...
type AuthServiceClient interface {
	...
	PromoteToModerator(ctx context.Context, in *PromoteToModeratorRequest, opts ...grpc.CallOption) (*PromoteToModeratorResponse, error)
...
func (c *authServiceClient) PromoteToModerator(ctx context.Context, in *PromoteToModeratorRequest, opts ...grpc.CallOption) (*PromoteToModeratorResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PromoteToModeratorResponse)
	err := c.cc.Invoke(ctx, AuthService_PromoteToModerator_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	PromoteToModerator(context.Context, *PromoteToModeratorRequest) (*PromoteToModeratorResponse, error)
...
func (UnimplementedAuthServiceServer) PromoteToModerator(context.Context, *PromoteToModeratorRequest) (*PromoteToModeratorResponse, error) {
...
func _AuthService_PromoteToModerator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PromoteToModeratorRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).PromoteToModerator(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_PromoteToModerator_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).PromoteToModerator(ctx, req.(*PromoteToModeratorRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_PromoteToModerator_Handler,
		},
		{
			MethodName: "GetMe",
